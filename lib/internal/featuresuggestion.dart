...
void main() {
  ...
  runApp(const MySuggestion.MyBugreport());
}

class MySuggestion extends StatelessWidget {
  const MySuggestion.MyBugreport({Key? key});
...
class _suggestPageState extends State<suggestPage> {
  ...
  Future<void> sendReport() async {
    ...
    try {
      ...
      String url =
          'https://api.srv1.french-femboi.eu/api/database/rows/table/1096/?user_field_names=true';
